...
parser.add_option('-x', '--xdups', default=0,          help='adjust hitrate for x removed duplicates from trace',                    action='store', type='int', dest='xdups')
...
if options.solve == False:
    ...
    print ('')
    print ('FINALSTATS hits %d   misses %d   hitrate %.4f' % (hits, miss, (100.0*float(hits+xdups))/(float(hits+xdups)+float(miss))))
    print ('')
